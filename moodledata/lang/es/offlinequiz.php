...
$string['configdecimalplaces'] = 'Número de cifras que deben ser mostradas después del punto decimal cuando se muestras las calificaciones del cuestionario offline (sin conexión).';
...
$string['gradeswarning'] = '¡Las calificaciones de las preguntas deben ser numeros!';
$string['gradewarning'] = '¡La calificación de la pregunta debe ser un número!';
...
$string['pdfintrotext'] = '<b>¿Cómo tengo que marcar correctamente?</b><br />Este formulario de respuesta será escaneado automáticamente. Por favor, no lo doble o manche. Utilice un bolígrafo negro o azul para marcar los campos. Si quiere corregir una marca, rellene la casilla completamente con color. Este campo será interpretado como una casilla vacía.<br />';
...
$string['quizdate'] = 'Fecha del cuestionario offline';
...
$string['reviewcloses'] = 'La revisión cierra';
...
$string['reviewopens'] = 'La revisión abre';
