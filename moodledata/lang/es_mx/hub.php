...
/**
 * Strings for component 'hub', language 'es_mx', branch 'MOODLE_36_STABLE'
 *
 * @package   hub
...
$string['registermoochtips'] = 'Al registrarse, Usted recibirá alertas de seguridad, puede activar notificaciones push mobile de su sitio y estará contribuyendo a nuestras estadísticas Moodle de la comunidad mundial.';
...
$string['registerwithmoodleorgremove'] = 'Eliminando el registro de su sitio';
...
$string['urlalreadyregistered'] = 'Parece que su sitio ya estaba registrado, lo que significa que algo ha ido mal. Póngase en contacto con el administrador de Moodle,net para que reinicie su registro y usted pueda intentarlo de nuevo.';
