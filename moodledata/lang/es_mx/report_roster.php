...
/**
 * Strings for component 'report_roster', language 'es_mx', branch 'MOODLE_36_STABLE'
 *
...
$string['settings:show_username'] = 'Mostrar nombre_de_usuario';
$string['settings:show_username:description'] = 'Mostrar nombre_de_usuario debajo del nombre completo en el Reporte de la Lista';
