...
/**
 * Strings for component 'quiz', language 'es_mx', branch 'MOODLE_36_STABLE'
 *
 * @package   quiz
...
$string['canredoquestions_desc'] = 'Si se habilita, entonces cuando los estudiantes hayan terminado una pregunta, ellos verán un botón para \'Re-hacer la pregunta\'. Esto les permite intentar otra versión de la misma pregunta, sin tener enviar el examen completo e iniciar otro examen nuevo. Esta opción es útil para exámenes de práctica.
...
$string['canredoquestions_help'] = 'Si se habilita, entonces cuando los estudiantes hayan terminado una pregunta, ellos verán un botón para \'Re-hacer la pregunta\'. Esto les permite intentar otra versión de la misma pregunta, sin tener enviar el examen completo e iniciar otro examen nuevo. Esta opción es útil para exámenes de práctica.
