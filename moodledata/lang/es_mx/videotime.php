...
/**
 * Strings for component 'videotime', language 'es_mx', branch 'MOODLE_36_STABLE'
 *
 * @package   videotime
...
$string['label_mode_help'] = 'Incrustar video en diseño del curso, similar a la actividad Etiqueta';
...
$string['preview_image'] = 'Previsualizar imagen';
$string['preview_image_help'] = 'Imagen mostrada para el usuario.';
