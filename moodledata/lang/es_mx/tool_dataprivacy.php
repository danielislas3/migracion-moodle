...
/**
 * Strings for component 'tool_dataprivacy', language 'es_mx', branch 'MOODLE_36_STABLE'
 *
...
$string['errorcannotdeleteadmin'] = 'No se puede crear solicitud de eliminación para el administrador primario del sitio';
