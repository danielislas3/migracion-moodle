...
/**
 * Strings for component 'admin', language 'es_mx', branch 'MOODLE_36_STABLE'
 *
 * @package   admin
...
-Moodle soporte gratuito|httsp://moodle.org/support
-Moodle Docs|https://docs.moodle.org|Moodle Docs
-Moodle Documentación en Español|https://docs.moodle.org/all/es/Página_Principal |Documentación en Español |es
-###
-Moodle desarrollo|httsp://moodle.org/development
...
$string['configdebugsmtp'] = 'Activa la depuración con información detallada durante el envío de correos electrónicos al servidor SMTP. Para que tenga efecto esta configuración, la configuración de \'Depurar mensajes\' debe estar configurada a \'Desarrollador\'.';
...
$string['moodleapp_help'] = '<p>Si Usted tiene una cuenta en un sitio Moodle, Usted puede acceder a todos sus cursos en sus dispositivos móviles con nuestra App mobile gratuta para Moodle.</p>
