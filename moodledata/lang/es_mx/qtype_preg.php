...
$string['engine_help'] = '<p>No hay un  \'mejor\' motor de concordancia, por lo que Usted puede elegir el motor que se adapte a la pregunta particular.</p><p>El <b>motor de concordancia PHP preg</b> nativo funciona usando la función preg_match() del lenguaje PHP .Es casi 100% libre-de-errores y puede trabajar con sintaxis completa PCRE, pero no puede soportar características avanzadas (mostrar pistas y concordancias parciales).</p><p><b>El motor de concordancia Autómata de Estado Finito (FA)</b> usa código de concordancia personalizado. Soporta dar pistas y concordancias parciales, pero no soporta aserciones \'lookaround\' (se le notificará cuando intente guardar una pregunta con expresiones no soportadas) y potencialmente podría contener errores.</p><p>Si la diferencia entre motores es demasiado difícil para Usted, simplemente intente usarlos todos para ver como sus capacidades se adaptan a sus necesidades. Si un motor falla en una pregunta, entonces intente otros motores para ver si pueden manejarla mejor.</p><p>El motor FA probablemente es la mejor opción si Usted no usa aserciones \'lookaround\' .</p>';
...
Para preguntas en idioma español debemos seleccionar \'Inglés\'.';
