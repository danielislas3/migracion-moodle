...
class __Mustache_0f430ca5a6d3de435657d0cb22ac3d66 extends Mustache_Template
{
...
';
            $buffer .= $indent . '              <p>Plataforma hecha con <i class="text-danger fa fa-heart"></i> por <a href="http://danielislas3.com">Daniel Orio</a></p>
';
            $buffer .= $indent . '          </div>
';
            $buffer .= $indent . '      </div>
