...
class __Mustache_00c51a1b8e5884d03d628b646432f967 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section25e9a416fd4477b1594ca20fee9128fc($context, $indent, $value);
        $buffer .= $indent . '        </tbody>
';
        $buffer .= $indent . '    </table>
';
...
';
    ...
    private function section6ce798d2ce66d13ed4fc8c7d2cf51783(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section7e5abd639ce80b63d939c027fd45ce8e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                if ($parent = $this->mustache->loadPartial('core_calendar/minicalendar_day_link')) {
                    $context->pushBlockContext(array(
                        ...
                        'content' => array($this, 'block4cb182d821bda87a93e307a07492b70a'),
                    ));
    ...
    private function section8aeebd1073fc899ca5722e631db5d934(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section7e5abd639ce80b63d939c027fd45ce8e($context, $indent, $value);
...
';
    ...
    private function section25e9a416fd4477b1594ca20fee9128fc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section8aeebd1073fc899ca5722e631db5d934($context, $indent, $value);
                // 'postpadding' section
...
';
    ...
    public function block4cb182d821bda87a93e307a07492b70a($context)
    {
        $indent = $buffer = '';
        // 'events' section
        $value = $context->find('events');
        $buffer .= $this->section6ce798d2ce66d13ed4fc8c7d2cf51783($context, $indent, $value);
