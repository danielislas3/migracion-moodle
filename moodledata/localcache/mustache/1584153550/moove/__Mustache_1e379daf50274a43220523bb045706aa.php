...
class __Mustache_1e379daf50274a43220523bb045706aa extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockE9c81aadb733dbd8b19bf38a032c5881'),
            ));
...
';
    ...
    public function blockE9c81aadb733dbd8b19bf38a032c5881($context)
    {
        $indent = $buffer = '';
