...
class __Mustache_2517b1902ae38d7a420765f017b9c666 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block8a00b1302e42050ffb417e4b21d74b63'),
            ));
...
';
    ...
    public function block8a00b1302e42050ffb417e4b21d74b63($context)
    {
        $indent = $buffer = '';
